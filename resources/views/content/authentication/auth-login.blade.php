	...
	<div class="d-none d-lg-flex col-lg-8 align-items-center ">
	  <div class="w-100 d-lg-flex align-items-center justify-content-center ">
		@if($configData['theme'] === 'dark')
		  <img class="img-fluid" src="{{asset('images/login/camionGO-logo.png')}}" style="max-width:70%" alt="Login V2" />
		  @else
		  <img class="img-fluid" src="{{asset('images/login/camionGO-logo.png')}}" style="max-width:70%" alt="Login V2" />
		  @endif
	  </div>
	...
	<div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
	  <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
		...
		<div class="text-center">
			...
			<p class="card-text mb-2">Inicie sesión en su cuenta</p>
		</div>
		...
		<form class="auth-login-form mt-2" action="{{route('login')}}" method="POST">
		  ...
		  <div class="mb-1">
			...
			<input class="form-control @error('email') error @enderror" id="email" type="text" name="email" placeholder="user@demo.pe" value="{{old('email')}}" aria-describedby="email @error('email'){{'email-error'}}@enderror" autofocus="" tabindex="1" />
			@error('email')
